Attribute VB_Name = "NS_Helper_Functions"
'---------------------------------------------------------------------
...
' Returns      : Boolean
'---------------------------------------------------------------------
Function CheckFileExists(ByRef sDirectory As String, _
ByVal sFileName As String, ByVal fileExt As String) As Boolean
    ...
    sFile = sDirectory & sFileName & fileExt
...
End Function
Function SaveReturnXLSX(ByRef wbTMP As Workbook, ByRef tmpSheet As Worksheet, _
...
Function ChangeName(ByVal FileExist As Boolean, ByVal sPath As String, ByVal fName As String) As String
    ...
    Do Until Dir(sPath & fName & "_" & i & ".xlsx") = ""
        i = i + 1
    Loop
    ChangeName = fName & "_" & i
